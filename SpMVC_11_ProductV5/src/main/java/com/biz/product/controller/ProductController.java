...
public class ProductController {
	...
	public String getAllList(@RequestParam(value="currentPageNo", required = false, defaultValue = "1") int currentPageNo, Model model) {
		
		long totalCount = productSvc.totalCount();
		PageDTO page = pageSvc.getPagination(totalCount, currentPageNo);
		List<ProductDTO> proList = productSvc.selectPagination(page);
