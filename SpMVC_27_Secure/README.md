...
* 위의 설정을 마친 뒤 utils 패키지의 EncMySQL, EncGmail, EncNaver 클래스로 MySQL, Gmail 아이디,비밀번호를 입력한 뒤 properties 생성하기 (현재 Gmail SMTP를 이용하기 때문에 Naver는 사용하지 않으나 properties는 필요하기에 아무 값이나 입력해서 생성해놓기)
