...
public class ImgController {
	...
	ImageServiceV2 imageSvc;// Interface이므로 @Qualifier() 사용 불가, 클래스는 사용 가능
	ImageFileService ifSvc;
	
	@Autowired
	public ImgController(ImageServiceV2 imageSvc, ImageFileService ifSvc) {
...
//		}
	...
	public String delete(@PathVariable("img_seq") String img_seq) {
	...
	public String delete(@RequestParam("img_seq") String img_seq, String dummy) {
