...
<div class="flex">
	<span class="span1">메일번호</span><span>${emailVO.emsSeq}</span><span>날짜</span><span>${emailVO.sendDate} ${emailVO.sendTime}</span>
</div>

<div class="flex">
	<span class="span1">발신</span><span>${emailVO.fromName}</span><span class="spanMail">${emailVO.fromEmail}</span>
</div>
