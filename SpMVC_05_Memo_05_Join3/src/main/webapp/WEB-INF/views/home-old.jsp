	            ...
	            <article class="list">
	            	<c:choose>
	            		<c:when test="${BODY == 'JOIN'}">
	            			<%@ include file="/WEB-INF/views/user/user-insert.jsp" %>
	            		</c:when>
	            		...
	            		<c:when test="${BODY == 'MEMO_WR'}">
	            			<%@ include file="/WEB-INF/views/memo/memo-insert.jsp" %>
	            		</c:when>
	            		
	            		<c:when test="${BODY == 'MEMO_VI'}">
	            			<%@ include file="/WEB-INF/views/memo/memo-view.jsp" %>
	            		</c:when>
	            		
	            		<c:otherwise>
	            			<%@ include file="/WEB-INF/views/memo/memo-list.jsp" %>
	            		</c:otherwise>
	            	</c:choose>
	            </article>
	            <div class="b-box">
