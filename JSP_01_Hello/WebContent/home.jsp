...
<body>
	...
	<h4><%= sum %></h4>
	<p>paragraph</p>
	<p>웹페이지에는 Enter의 의미가 없다</p>
	<p>한 개 문단 내의 문자열이 너무 길어서 한 줄에 표시가 되지 않을 때는 자동으로 다음줄로 넘어가게 된다. 이러한 것을 Auto Word-Wrap 이라고 한다</p>
	<p>문서를 작성하면서 Enter키를 입력해도
	웹페이지에서는 1개의 빈 칸으로 인식한다(space)
	여러 줄에 걸쳐 문서를 작성하기 위해서는 Enter를 입력하지만
	실제 웹페이지에서 볼 때는 1개의 빈 칸으로 보이게 된다</p>
