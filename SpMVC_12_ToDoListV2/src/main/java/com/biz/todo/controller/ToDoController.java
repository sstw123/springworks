...
public class ToDoController {
	...
	public String complete(@RequestParam("td_seq") String strSeq) {
	...
	public String alarm(@RequestParam("td_seq") String strSeq) {
	...
	public String update(@RequestParam("td_seq")String strSeq, Model model) {
		...
		ToDoList toDoList = todoSvc.selectBySeq(strSeq);
		model.addAttribute("todoDTO", toDoList);
		
		List<ToDoList> tdList = todoSvc.selectAll();
	...
	public String update(ToDoList toDoList) {
		
		todoSvc.update(toDoList);
