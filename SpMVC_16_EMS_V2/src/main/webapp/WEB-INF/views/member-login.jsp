...
<link rel="stylesheet" type="text/css" href="${rootPath}/resources/css/member-login.css">

<script>var rootPath = "${rootPath}"</script>
<script src="${rootPath}/resources/js/member-login.js"></script>
...
<form method="POST" action="${rootPath}/member/login" class="login-form">
	...
	<div class="naver_login">
		<img src="${rootPath}/resources/image/naver_green.png" width="200px" alt="naver_login_green">
		<img src="${rootPath}/resources/image/naver_white.png" width="200px" alt="naver_login_white">
	</div>
